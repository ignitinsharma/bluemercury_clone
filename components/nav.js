function nav(){
  ...
  <div id="navmain">
    <div id="topnav">
      <div>
        <span
          ><i
            ...
            style="font-size: 20px; color: #12284c"
          >
            <span style="font-size: 12px; color: #12284c"
              >STORE AND SPA LOCATION</span
            ></i
          ></span
        >
      </div>
      <div id="search">
        <span>
          <i class="fa fa-heart" style="font-size: 20px; color: #12284c"
            ><span style="font-size: 15px; color: #12284c">Wishlist</span></i
          ></span
        >
        <span>
          <i class="fa fa-search" style="font-size: 20px; color: #12284c"
            ><span style="font-size: 15px; color: #12284c">SEARCH</span></i
          ></span
        >
        <span>
          <i class="fa fa-user" style="font-size: 20px; color: #12284c"
            ><span style="font-size: 15px; color: #12284c"
              ><a id="signup" href="./signin.html"> SIGN IN/UP</a></span
            ></i
          ></span
        >
        <span>
          <i class="fa fa-briefcase" style="font-size: 20px; color: #12284c"
            ><span style="font-size: 15px; color: #12284c"> <a id="signup" href="./cart.html">BAG</a></span></i
          ></span
        >
      </div>
    </div>
    <div id="nav">
      ...
      <div id="navbar">
        <ul>
          ...
          <!-- ================== New dropdown ================= -->
          <li>
            <a id="dropanchor" href="./news.html">NEW!</a>
            <div id="newdropdown">
              <ul>
                <li>
                  <a style="color: #3e506d; font-weight: 600" href=""
...
MORE -->
          ...
          <!-- ============== ROUTINE REBOOT ================= -->
          <li>
            <a id="dropanchor" href="./routin.html">ROUTINE REBOOT</a>
